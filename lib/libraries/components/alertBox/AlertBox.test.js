...
describe("AlertBox Component", function () {
    ...
    it("Should get good styling and correct message", function () {
        var alertContainer = new AlertBox(AlertType.Success, "Success Message");
    ...
    it("Should get attention styling and correct message", function () {
        var alertContainer = new AlertBox(AlertType.Failure, "Failure Message");
        expect(alertContainer).toBeDefined();
        expect(alertContainer.items[0].items.length).toEqual(1);
        expect(alertContainer.items[0].items[0].columns[0].items.length).toEqual(3);
    ...
    it("Should get warning styling and correct message", function () {
        var alertContainer = new AlertBox(AlertType.Warning, "Warning Message");
        expect(alertContainer).toBeDefined();
        expect(alertContainer.items[0].items.length).toEqual(1);
        expect(alertContainer.items[0].items[0].columns[0].items.length).toEqual(3);
    ...
    it("Should contain alert action - dismiss", function () {
        var alertContainer = new AlertBox(AlertType.Success, "Success Message", {
            actionId: "dimissId",
            actionText: "Dismiss",
            actionData: { data: "1" },
    ...
    it("Should contain alert confirmation", function () {
        var alertContainer = new AlertBox(AlertType.Success, "Success Message", null, {
            cancelId: "cancelId",
            cancelText: "Cancel",
...
//# sourceMappingURL=AlertBox.test.js.map