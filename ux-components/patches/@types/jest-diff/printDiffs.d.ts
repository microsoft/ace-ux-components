...
export declare const printDeleteLine: (
  line: string,
  isFirstOrLast: boolean,
  { aColor, aIndicator, changeLineTrailingSpaceColor, emptyFirstOrLastLinePlaceholder }: DiffOptionsNormalized
) => string;
export declare const printInsertLine: (
  line: string,
  isFirstOrLast: boolean,
  { bColor, bIndicator, changeLineTrailingSpaceColor, emptyFirstOrLastLinePlaceholder }: DiffOptionsNormalized
) => string;
export declare const printCommonLine: (
  line: string,
  isFirstOrLast: boolean,
  { commonColor, commonIndicator, commonLineTrailingSpaceColor, emptyFirstOrLastLinePlaceholder }: DiffOptionsNormalized
) => string;
...
export declare const printAnnotation: (
  {
    aAnnotation,
    aColor,
    aIndicator,
...
export declare const createPatchMark: (
  aStart: number,
  aEnd: number,
  bStart: number,
  bEnd: number,
